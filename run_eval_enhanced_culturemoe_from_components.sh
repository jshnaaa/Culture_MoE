...
if [ "$BACKBONE" = "qwen" ]; then
    ...
    MOE_WEIGHTS_BASE="/root/autodl-fs/data/ft/ft_enhanced_moe_gen_unified_all_datasets_qwen_experts${NUM_EXPERTS}_${SHARED_TAG}_fusion${MOE_FUSION}_lambda${LAMBDA}_20251116_1537"
else
...
echo "============================================================"
echo "🧪 Enhanced CultureMoE Evaluation (From Components - Fixed)"
echo "============================================================"
