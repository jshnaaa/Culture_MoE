...
# -*- coding: utf-8 -*-
"""
Mistral-Small-3.1 API评测脚本
使用Mistral-Small-3.1模型对文化数据集进行评测
"""
...
def parse_args():
    """解析命令行参数"""
    parser = argparse.ArgumentParser(description='Mistral-Small-3.1 API评测脚本')
    ...
    parser.add_argument('--output_dir', type=str, required=True,
                        help='输出目录')
    parser.add_argument('--model_name', type=str, default='mistralai/mistral-small-3.1-24b-instruct:free',
                        help='模型名称 (默认: mistralai/mistral-small-3.1-24b-instruct:free)')
...
def evaluate_dataset(
    ...
    for idx, sample in enumerate(tqdm(data, desc="评测进度")):
        ...
        # 调用Mistral API
        response, success = call_mistral_api(
...
def main():
    ...
    print("=" * 50)
    print("Mistral-Small-3.1 API 评测脚本")
    print("=" * 50)
