...
LOG_DIR="/root/autodl-fs/output/batch_lora_only_test_logs"
mkdir -p $LOG_DIR
...
sh run_eval_lora_only.sh llama 2 2>&1 | tee -a $BATCH_LOG
TASK1_STATUS=$?
...
sh run_eval_lora_only.sh llama 4 2>&1 | tee -a $BATCH_LOG
TASK2_STATUS=$?
...
sh run_eval_lora_only.sh qwen 2 2>&1 | tee -a $BATCH_LOG
TASK3_STATUS=$?
...
sh run_eval_lora_only.sh qwen 4 2>&1 | tee -a $BATCH_LOG
TASK4_STATUS=$?
